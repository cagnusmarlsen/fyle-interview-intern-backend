...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        is_correct_teacher = auth_principal.teacher_id == assignment.teacher_id

        assertions.assert_valid(is_principal or is_correct_teacher, 'This assignment belongs to another teacher')
